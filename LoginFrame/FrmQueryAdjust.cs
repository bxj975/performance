...
{
    public partial class FrmQueryAdjust : Form
    {
        DataTable dsLog;
        public FrmQueryAdjust()  //初始化组件
        {
            InitializeComponent();
        }
        ...
        public void BindData(string strClass)
        {
            ...
            dsLog = DAL.performance.GetAdjust(NowPage, PageSize, out AllPage, out DataCount, HWhere.Text);
        ...
        /*开始加载窗体后*/
        private void FrmQueryAdjust_Load(object sender, EventArgs e)
        {
            this.checkBox1.Checked = DAL.dalBook.getBool(2);
            this.textBox1.Text = DAL.dalBook.getString(2);

...
namespace LoginFrame
{
    public partial class FrmQueryReward : Form
    {
        ...
        private void Btn_Query_Click(object sender, EventArgs e)  //搜索条件
        {
            ...
            DAL.dalBook.Update("U_Row", rows, 5);
        }
        ...
        public void BindData(string strClass)
        {
            ...
            dsLog = DAL.performance.GetReward(NowPage, PageSize, out AllPage, out DataCount, HWhere.Text);
        ...
        /*开始加载窗体后*/
        private void FrmQueryReward_Load(object sender, EventArgs e)
        {
            this.checkBox1.Checked = DAL.dalBook.getBool(5);
            this.textBox1.Text = DAL.dalBook.getString(5);

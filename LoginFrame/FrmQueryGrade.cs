...
{
    public partial class FrmQueryGrade : Form
    {
        DataTable dsLog;
        public FrmQueryGrade()  //初始化组件
        {
            InitializeComponent();
        }
        ...
        private void Btn_Query_Click(object sender, EventArgs e)  //搜索条件
        {
            ...
            DAL.dalBook.Update("U_Row", rows, 3);
        }
        ...
        public void BindData(string strClass)
        {
            ...
            dsLog = DAL.performance.GetGrade(NowPage, PageSize, out AllPage, out DataCount, HWhere.Text);
        ...
        /*开始加载窗体后*/
        private void FrmQueryGrade_Load(object sender, EventArgs e)
        {
            this.checkBox1.Checked = DAL.dalBook.getBool(3);
            this.textBox1.Text = DAL.dalBook.getString(3);

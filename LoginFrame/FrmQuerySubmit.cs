...
{
    public partial class FrmQuerySubmit : Form
    {
        DataTable dsLog;
        public FrmQuerySubmit()  //初始化组件
        {
            InitializeComponent();
        }
        ...
        public void BindData(string strClass)
        {
            ...
            dsLog = DAL.performance.GetSubmit(NowPage, PageSize, out AllPage, out DataCount, HWhere.Text);
        ...
        /*开始加载窗体后*/
        private void FrmQuerySubmit_Load(object sender, EventArgs e)
        {
            this.checkBox1.Checked = DAL.dalBook.getBool(6);
            this.textBox1.Text = DAL.dalBook.getString(6);
